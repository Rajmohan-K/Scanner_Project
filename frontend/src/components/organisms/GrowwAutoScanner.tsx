  ...
  useEffect(() => {
    ...
    async function tick(force = false) {
      ...
      try {
        ...
        toast.push(`Auto Groww quick analysis synced ${result.rows.length} intraday opportunities`, 'success', { dedupeKey: 'groww-auto-success' });
      } catch (error: any) {
        toast.push(error?.message || 'Auto Groww quick analysis failed', 'error', { dedupeKey: 'groww-auto-error' });
      } finally {
